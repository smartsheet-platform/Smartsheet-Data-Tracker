...
def main():
	...
	logger.info('***Smartsheet Data Aggregator Utility Started: {}'.format(str(datetime.datetime.now()).split('.')[0]))
	...
	print
	print ' Smartsheet Data Aggregator'
	print '============================'
	...
	if len(mappings):
		...
		logger.info('===Smartsheet Data Aggregator Utility Completed: {}'.format(str(datetime.datetime.now()).split('.')[0]))
	else:
